...
class Mision3B1C_G4(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Mision 3 EP CR", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Mision 3 EP CR")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Mision3B1C_G4")
        ...
        self._ka_range = qtgui.Range(0, 100, 0.01, 20, 200)
        ...
        self._fc_win = qtgui.RangeWidget(self._fc_range, self.set_fc, "frecuencia TX [MHz]", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._fm_win = qtgui.RangeWidget(self._fm_range, self.set_fm, "fecuencia mensaje", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._Am_win = qtgui.RangeWidget(self._Am_range, self.set_Am, "Amplitud TX", "counter_slider", float, QtCore.Qt.Horizontal)
...
def main(top_block_cls=Mision3B1C_G4, options=None):
